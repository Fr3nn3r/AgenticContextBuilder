...
const SCREEN_ACCESS: Record<Screen, Role[]> = {
  ...
  'classification-review': ['admin', 'operator', 'auditor'],
  'claims-table': ['admin', 'operator', 'auditor'],
  'claim-review': ['admin', 'operator', 'auditor'],
  ...
  'evaluation': ['admin', 'operator', 'auditor'],
  'all-claims': ['admin', 'operator', 'auditor'],
  'claims-explorer': ['admin', 'operator', 'auditor'],
  'documents': ['admin', 'reviewer', 'operator', 'auditor'],
  'costs': ['admin', 'auditor'],
  'decision-dossier': ['admin', 'reviewer', 'operator', 'auditor'],
};

const SCREEN_EDIT: Record<Screen, Role[]> = {
  'batch-workspace': ['admin', 'operator'],
  'document-review': ['admin'],
  'classification-review': ['admin'],
  'claims-table': ['admin', 'operator'],
  'claim-review': ['admin'],
  ...
  'admin': ['admin'],
  // Nav screens
  'batches': ['admin', 'operator'],
  'evaluation': ['admin'],
  'all-claims': ['admin', 'operator'],
  'claims-explorer': ['admin'],
