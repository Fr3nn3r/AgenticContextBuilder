  ...
  return (
    <div className="w-56 bg-gray-900 text-white flex flex-col">
      ...
      <div className="p-4 flex items-center gap-2">
        ...
        <span className="font-semibold text-lg">ClaimEval</span>
      </div>
      ...
      <nav className="flex-1 px-2 py-4 space-y-1">
        {navItems.map((item) => {
          ...
          const isActive = currentView === item.id ||
            (item.id === "claims" && currentView === "review");
      ...
      <div className="p-4 border-t border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-medium truncate">Demo Reviewer</div>
            <div className="text-xs text-gray-500 truncate">reviewer@demo.claimeval.com</div>
          </div>
        </div>
        <div className="mt-3">
          ...
          <div className="text-xs text-gray-600 mt-1">Demo mode - switch roles to test</div>
        </div>
        <button className="mt-4 flex items-center gap-2 text-sm text-gray-400 hover:text-white">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
